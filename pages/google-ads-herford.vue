          ...
          >
            ...
            <div data-aos="fade-right">
              ...
              <p class="text-xl text-white mb-8 leading-relaxed">
                Professionelle Google Ads Betreuung direkt aus Herford.
                Maximieren Sie Ihren ROI mit gezielten Kampagnen für die
                Hansestadt.
              </p>
              ...
              <div class="space-y-4 mb-8">
                ...
                <div class="flex items-center gap-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f60" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
                  <span class="text-white">Persönliche Betreuung aus Herford</span>
                </div>
              </div>
...
useHead({
  title:
    "Google Ads Agentur Herford | Professionelle Kampagnen-Betreuung | Orangize",
  meta: [
    {
      name: "description",
      content:
        "Google Ads Agentur Herford ✓ Professionelle Kampagnen für die Hansestadt ✓ ROI-Optimierung ✓ Lokale Expertise ✓ Kostenlose Beratung ✓ Messbare Ergebnisse.",
    },
    {
      name: "keywords",
      content:
        "google ads herford, google ads agentur herford, sea agentur hansestadt, google ads beratung herford, google adwords herford, google ads optimierung, ppc agentur herford, google kampagnen herford",
    },
    {
      property: "og:title",
      content:
    ...
    },
    {
      ...
      content:
        "Professionelle Google Ads Agentur in Herford. Spezialisiert auf ROI-Optimierung und messbare Ergebnisse für Unternehmen in der Hansestadt. Kostenlose Erstberatung!",
    },
    {
      property: "og:type",
      content: "website",
