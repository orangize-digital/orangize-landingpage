<template>
  <div>
    <Navigation />
    <!-- Hero — pain-point: wasted ad budget → real inquiries (Herford) -->
      ...
      <div class="hero-shell__inner container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          <div class="lg:col-span-7" data-aos="fade-right">
            <p class="hero-shell__eyebrow">Google Ads · Herford</p>
            <h1 class="hero-shell__headline">
              Google Ads Agentur in Herford.<br />
            ...
            <p class="hero-shell__sub">
              ...
              Kampagnen für Unternehmen in Herford und Ostwestfalen-Lippe, die nachweisbar
...
// SEO Meta Tags für Google Ads Betreuung in Herford und Umgebung
useHead({
  htmlAttrs: { lang: "de" },
  title: "Google Ads Agentur Herford | Professionelle Kampagnen-Betreuung | Orangize",
  meta: [
    { name: "description", content: "Google Ads Agentur Herford ✓ Professionelle Kampagnen für die Hansestadt ✓ ROI-Optimierung ✓ Lokale Expertise ✓ Kostenlose Beratung ✓ Messbare Ergebnisse." },
    { name: "keywords", content: "google ads herford, google ads agentur herford, sea agentur hansestadt, google ads beratung herford, google adwords herford, google ads optimierung, ppc agentur herford, google kampagnen herford" },
    { name: "author", content: "Orangize Digital" },
    { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1" },
    { name: "geo.region", content: "DE-NW" },
    { name: "geo.placename", content: "Herford" },
    { property: "og:title", content: "Google Ads Agentur Herford | Professionelle Kampagnen-Betreuung | Orangize" },
    { property: "og:description", content: "Professionelle Google Ads Agentur in Herford. Spezialisiert auf ROI-Optimierung und messbare Ergebnisse für Unternehmen in der Hansestadt. Kostenlose Erstberatung!" },
    ...
    { property: "og:image:alt", content: "Google Ads Agentur Herford | Professionelle Kampagnen-Betreuung | Orangize" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Google Ads Agentur Herford | Professionelle Kampagnen-Betreuung | Orangize" },
    { name: "twitter:description", content: "Professionelle Google Ads Agentur in Herford. Spezialisiert auf ROI-Optimierung und messbare Ergebnisse für Unternehmen in der Hansestadt. Kostenlose Erstberatung!" },
        ...
        "@graph": [
          {
            ...
            name: "Google Ads Agentur Herford",
            description: "Google Ads Agentur Herford ✓ Professionelle Kampagnen für die Hansestadt ✓ ROI-Optimierung ✓ Lokale Expertise ✓ Kostenlose Beratung ✓ Messbare Ergebnisse.",
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Google Ads Agentur Herford", item: `https://orangize.de${route.path}` },
            ],
          },
        ],
      }),
