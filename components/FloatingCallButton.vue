...
<template>
  <div class="fixed right-4 bottom-24 z-50">
    ...
    >
      <div
        class="absolute flex items-center justify-center bg-white rounded-full w-14 h-14 shadow-lg top-1 right-1"
      >
      ...
      <div
        class="flex items-center font-medium justify-center h-full opacity-0 w-40 transition-all duration-300 group-hover:opacity-100 group-hover:mr-8 group-hover:w-40 text-white"
      >
        Kontakt Aufnehmen
      </div>
    </a>
