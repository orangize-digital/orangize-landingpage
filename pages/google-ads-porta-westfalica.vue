          ...
          >
            ...
            <div data-aos="fade-right">
              ...
              >
                ...
                <span class="text-primary">Porta Westfalica</span>
              </h1>
              <p class="text-xl text-white mb-8 leading-relaxed">
                Professionelle Google Ads Betreuung direkt aus Porta Westfalica.
              ...
              <div class="space-y-4 mb-8">
                ...
                <div class="flex items-center gap-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f60" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
                  <span class="text-white">Persönliche Betreuung aus Porta Westfalica</span>
                </div>
              </div>
...
useHead({
  title:
    "Google Ads Agentur Porta Westfalica | Professionelle Betreuung & Optimierung | Orangize",
  meta: [
    {
      name: "description",
      content:
        "Google Ads Agentur Porta Westfalica ✓ Professionelle Kampagnen-Betreuung ✓ ROI-Optimierung ✓ Lokale Expertise für Weserbergland ✓ Kostenlose Beratung ✓ Messbare Ergebnisse.",
    },
    {
      name: "keywords",
      content:
        "google ads porta westfalica, google ads agentur porta westfalica, sea agentur weserbergland, google ads beratung porta westfalica, google adwords porta westfalica, google ads optimierung, ppc agentur porta westfalica, google kampagnen weserbergland",
    },
    {
      property: "og:title",
      content:
    ...
    },
    {
      ...
      content:
        "Professionelle Google Ads Agentur in Porta Westfalica. Spezialisiert auf ROI-Optimierung und messbare Ergebnisse für Unternehmen im Weserbergland. Kostenlose Erstberatung!",
    },
    {
      property: "og:type",
      content: "website",
