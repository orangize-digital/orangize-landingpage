          ...
          <div class="text-left text-neutral-content" data-aos="fade-right">
            <div class="mb-4">
              <span class="text-primary font-semibold text-lg"
                >Webdesign Porta Westfalica</span
              >
            </div>
            <h1
            ...
            <p class="text-xl lg:text-2xl mb-6 text-neutral-content/90">
              Ihre lokale Webdesign-Agentur für professionelle Websites in Porta
              Westfalica und Ostwestfalen
            </p>
            <div class="space-y-4 mb-8">
              ...
              <div class="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f60" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
                <span class="text-lg">Persönliche Betreuung vor Ort in Porta Westfalica</span>
              </div>
            </div>
...
useHead({
  title:
    "Website erstellen lassen in Porta Westfalica | Professionelles Webdesign | Orangize",
  meta: [
    {
      name: "description",
      content:
        "Website erstellen lassen in Porta Westfalica ✓ Lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung vor Ort in Porta Westfalica & Ostwestfalen.",
    },
    {
      name: "keywords",
      content:
        "Website erstellen lassen porta westfalica, webdesign porta westfalica, homepage erstellen porta westfalica, landingpage porta westfalica, webdesign agentur porta westfalica, professionelle Website porta westfalica, responsive webdesign porta westfalica",
    },
    {
      property: "og:title",
      content:
