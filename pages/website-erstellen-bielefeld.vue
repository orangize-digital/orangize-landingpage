        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="text-left text-neutral-content" data-aos="fade-right">
            ...
            >
              ...
              <span class="text-primary">Bielefeld</span>
            </h1>
            <p class="text-xl lg:text-2xl mb-6 text-neutral-content/90">
              Ihre Webdesign-Agentur für Bielefeld – Professionelle Websites aus
              Bad Oeynhausen für Unternehmen in Bielefeld
            </p>
            <div class="space-y-4 mb-8">
              ...
              <div class="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f60" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
                <span class="text-lg">Persönliche Betreuung für Bielefeld</span>
              </div>
            </div>
  ...
  meta: [
    {
      name: "description",
      content:
        "Website erstellen lassen in Bielefeld ✓ Professionelle Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung für Bielefelder Unternehmen.",
    },
    {
      name: "keywords",
      content:
        "Website erstellen lassen bielefeld, webdesign bielefeld, homepage erstellen bielefeld, landingpage bielefeld, webdesign agentur bielefeld, professionelle Website bielefeld, responsive webdesign bielefeld",
    },
    {
      property: "og:title",
      content:
        "Website erstellen lassen in Bielefeld | Webdesign Agentur | Orangize",
    },
    {
      property: "og:description",
      content:
        "Webdesign-Agentur aus Bad Oeynhausen für Bielefeld. Professionelle Websites und persönliche Betreuung für Unternehmen in Bielefeld und Ostwestfalen.",
    },
    {
      property: "og:type",
      content: "website",
