        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="text-left text-neutral-content" data-aos="fade-right">
            ...
            <div class="space-y-4 mb-8">
              ...
              <div class="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f60" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5" /></svg>
                <span class="text-lg">Persönliche Betreuung vor Ort in Minden</span>
              </div>
            </div>
...
useHead({
  title:
    "Website erstellen lassen in Minden | Professionelles Webdesign | Orangize",
  meta: [
    {
      name: "description",
      content:
        "Website erstellen lassen in Minden ✓ Lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung vor Ort in Minden & Ostwestfalen.",
    },
    {
      name: "keywords",
      content:
        "Website erstellen lassen minden, webdesign minden, homepage erstellen minden, landingpage minden, webdesign agentur minden, professionelle Website minden, responsive webdesign minden, seo Website minden",
    },
    {
      property: "og:title",
      content:
