<template>
  <div>
    <Navigation />
    <!-- Hero — pain-point: a website should sell, not just look nice (Bielefeld) -->
      ...
      <div class="hero-shell__inner container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          <div class="lg:col-span-7" data-aos="fade-right">
            <p class="hero-shell__eyebrow">Webdesign · Bielefeld</p>
            <h1 class="hero-shell__headline">
              Website erstellen lassen in Bielefeld.<br />
            ...
            <p class="hero-shell__sub">
              ...
              für Unternehmen in Bielefeld und Ostwestfalen-Lippe, die aus Besuchern messbar
            ...
            <div class="hero-shell__trust">
              ...
              <div>
                <div class="hero-shell__stat-num">Bielefeld</div>
      ...
      <div class="container mx-auto px-4">
        <div class="text-center mb-12">
          <h3 class="text-lg text-primary font-semibold" data-aos="fade-up">
            Ihre Webdesign-Agentur für Bielefeld
          </h3>
          <h2
            ...
            data-aos-delay="100"
          >
            Warum Bielefelder Unternehmen auf uns vertrauen
          </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right">
            <p class="text-lg text-base-content leading-relaxed">
              Als erfahrene Webdesign-Agentur aus Bad Oeynhausen betreuen wir
              Unternehmen in ganz Ostwestfalen – einschließlich Bielefeld. Wir
              verstehen die besonderen Anforderungen von Bielefelder Unternehmen
              und bieten persönliche Betreuung für nachhaltige Erfolge.
              <br /><br />
              Viele Bielefelder Unternehmen verlieren täglich potenzielle Kunden
              ...
              rund um die Uhr.
              <br /><br />
              Wir erstellen <strong>maßgeschneiderte Websites für Bielefeld</strong>, die
              nicht nur optisch überzeugen, sondern auch bei Google für
              "Bielefeld + Ihr Service" optimal gefunden werden. Mit <strong>lokaler
              SEO-Optimierung</strong> und einer <strong>conversion-orientierten Struktur</strong>
              bringen wir mehr Bielefelder Kunden zu Ihnen.
            </p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div class="card-body text-center">
              <div
                class="w-16 h-16 rounded-full bg-[#f60]/20 text-[#f60] flex items-center justify-center text-2xl font-bold mx-auto mb-6"
              >
                1
              </div>
          ...
          <div data-aos="fade-right">
            ...
            <ul class="space-y-4">
              <li class="flex items-start gap-4">
                <div
                  class="p-2 bg-[#f60] text-white rounded-full mt-1"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
...
// SEO Meta Tags für Webdesign & Website-Erstellung in Bielefeld
useHead({
  htmlAttrs: { lang: "de" },
  title: "Website erstellen lassen in Bielefeld | Webdesign Agentur | Orangize",
  meta: [
    { name: "description", content: "Website erstellen lassen in Bielefeld ✓ Professionelle Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung für Bielefelder Unternehmen." },
    { name: "keywords", content: "Website erstellen lassen bielefeld, webdesign bielefeld, homepage erstellen bielefeld, landingpage bielefeld, webdesign agentur bielefeld, professionelle Website bielefeld, responsive webdesign bielefeld" },
    { name: "author", content: "Orangize Digital" },
    { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1" },
    { name: "geo.region", content: "DE-NW" },
    { name: "geo.placename", content: "Bielefeld" },
    { property: "og:title", content: "Website erstellen lassen in Bielefeld | Webdesign Agentur | Orangize" },
    { property: "og:description", content: "Webdesign-Agentur aus Bad Oeynhausen für Bielefeld. Professionelle Websites und persönliche Betreuung für Unternehmen in Bielefeld und Ostwestfalen." },
    ...
    { property: "og:image:alt", content: "Website erstellen lassen in Bielefeld | Webdesign Agentur | Orangize" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Website erstellen lassen in Bielefeld | Webdesign Agentur | Orangize" },
    { name: "twitter:description", content: "Webdesign-Agentur aus Bad Oeynhausen für Bielefeld. Professionelle Websites und persönliche Betreuung für Unternehmen in Bielefeld und Ostwestfalen." },
        ...
        "@graph": [
          {
            ...
            name: "Website erstellen lassen in Bielefeld",
            description: "Website erstellen lassen in Bielefeld ✓ Professionelle Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung für Bielefelder Unternehmen.",
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Website erstellen lassen in Bielefeld", item: `https://orangize.de${route.path}` },
            ],
          },
        ],
      }),
