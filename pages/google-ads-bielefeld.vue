<template>
  <div>
    <Navigation />
    <!-- Hero — pain-point: wasted ad budget → real inquiries (Bielefeld) -->
      ...
      <div class="hero-shell__inner container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          <div class="lg:col-span-7" data-aos="fade-right">
            <p class="hero-shell__eyebrow">Google Ads · Bielefeld</p>
            <h1 class="hero-shell__headline">
              Google Ads Agentur in Bielefeld.<br />
            ...
            <p class="hero-shell__sub">
              ...
              Kampagnen für Unternehmen in Bielefeld und Ostwestfalen-Lippe, die nachweisbar
...
// SEO Meta Tags für Google Ads Betreuung in Bielefeld und Umgebung
useHead({
  htmlAttrs: { lang: "de" },
  title: "Google Ads Agentur Bielefeld | Professionelle Kampagnen-Betreuung | Orangize",
  meta: [
    { name: "description", content: "Google Ads Agentur Bielefeld ✓ Professionelle Kampagnen für OWL ✓ ROI-Optimierung ✓ Lokale Expertise ✓ Kostenlose Beratung ✓ Messbare Ergebnisse für Ostwestfalen-Lippe." },
    { name: "keywords", content: "google ads bielefeld, google ads agentur bielefeld, sea agentur owl, google ads beratung bielefeld, google adwords bielefeld, google ads optimierung, ppc agentur bielefeld, google kampagnen owl" },
    { name: "author", content: "Orangize Digital" },
    { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1" },
    { name: "geo.region", content: "DE-NW" },
    { name: "geo.placename", content: "Bielefeld" },
    { property: "og:title", content: "Google Ads Agentur Bielefeld | Professionelle Kampagnen-Betreuung | Orangize" },
    { property: "og:description", content: "Professionelle Google Ads Agentur in Bielefeld. Spezialisiert auf ROI-Optimierung und messbare Ergebnisse für Unternehmen in Ostwestfalen-Lippe. Kostenlose Erstberatung!" },
    ...
    { property: "og:image:alt", content: "Google Ads Agentur Bielefeld | Professionelle Kampagnen-Betreuung | Orangize" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Google Ads Agentur Bielefeld | Professionelle Kampagnen-Betreuung | Orangize" },
    { name: "twitter:description", content: "Professionelle Google Ads Agentur in Bielefeld. Spezialisiert auf ROI-Optimierung und messbare Ergebnisse für Unternehmen in Ostwestfalen-Lippe. Kostenlose Erstberatung!" },
        ...
        "@graph": [
          {
            ...
            name: "Google Ads Agentur Bielefeld",
            description: "Google Ads Agentur Bielefeld ✓ Professionelle Kampagnen für OWL ✓ ROI-Optimierung ✓ Lokale Expertise ✓ Kostenlose Beratung ✓ Messbare Ergebnisse für Ostwestfalen-Lippe.",
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Google Ads Agentur Bielefeld", item: `https://orangize.de${route.path}` },
            ],
          },
        ],
      }),
