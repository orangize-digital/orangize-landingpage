<template>
  <div>
    <Navigation />
    <!-- Hero — pain-point: a website should sell, not just look nice (Herford) -->
      ...
      <div class="hero-shell__inner container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          <div class="lg:col-span-7" data-aos="fade-right">
            <p class="hero-shell__eyebrow">Webdesign · Herford</p>
            <h1 class="hero-shell__headline">
              Website erstellen lassen in Herford.<br />
            ...
            <p class="hero-shell__sub">
              ...
              für Unternehmen in Herford und Ostwestfalen-Lippe, die aus Besuchern messbar
            ...
            <div class="hero-shell__trust">
              ...
              <div>
                <div class="hero-shell__stat-num">Herford</div>
      ...
      <div class="container mx-auto px-4">
        <div class="text-center mb-12">
          <h3 class="text-lg text-primary font-semibold" data-aos="fade-up">
            Webdesign-Agentur direkt in Herford
          </h3>
          <h2
            ...
            data-aos-delay="100"
          >
            Warum Herforeder Unternehmen auf uns vertrauen
          </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right">
            <p class="text-lg text-base-content leading-relaxed">
              Als lokale Webdesign-Agentur in Herford kennen wir die Bedürfnisse
              ...
              direkt vor Ort.
              <br /><br />
              Viele Herforeder Unternehmen verlieren täglich potenzielle Kunden
              ...
              rund um die Uhr.
              <br /><br />
              Wir erstellen <strong>maßgeschneiderte Websites für Herford</strong>, die nicht
              nur optisch überzeugen, sondern auch bei Google für "Herford + Ihr
...
// SEO Meta Tags für Webdesign & Website-Erstellung in Herford
useHead({
  htmlAttrs: { lang: "de" },
  title: "Website erstellen lassen in Herford | Professionelles Webdesign | Orangize",
  meta: [
    { name: "description", content: "Website erstellen lassen in Herford ✓ Lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Beratung vor Ort in Herford & Ostwestfalen." },
    { name: "keywords", content: "Website erstellen lassen herford, webdesign herford, homepage erstellen herford, landingpage herford, webdesign agentur herford, professionelle Website herford, responsive webdesign herford, seo Website herford" },
    { name: "author", content: "Orangize Digital" },
    { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1" },
    { name: "geo.region", content: "DE-NW" },
    { name: "geo.placename", content: "Herford" },
    { property: "og:title", content: "Website erstellen lassen in Herford | Professionelles Webdesign | Orangize" },
    { property: "og:description", content: "Professionelles Webdesign & moderne Websiten für Herford und Ostwestfalen. Lokale Betreuung und maßgeschneiderte Lösungen für Ihr Unternehmen." },
    ...
    { property: "og:image:alt", content: "Website erstellen lassen in Herford | Professionelles Webdesign | Orangize" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Website erstellen lassen in Herford | Professionelles Webdesign | Orangize" },
    { name: "twitter:description", content: "Professionelles Webdesign & moderne Websiten für Herford und Ostwestfalen. Lokale Betreuung und maßgeschneiderte Lösungen für Ihr Unternehmen." },
        ...
        "@graph": [
          {
            ...
            name: "Website erstellen lassen in Herford",
            description: "Website erstellen lassen in Herford ✓ Lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Beratung vor Ort in Herford & Ostwestfalen.",
            url: `https://orangize.de${route.path}`,
            areaServed: { "@type": "City", name: "Herford" },
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Website erstellen lassen in Herford", item: `https://orangize.de${route.path}` },
            ],
          },
        ],
      }),
