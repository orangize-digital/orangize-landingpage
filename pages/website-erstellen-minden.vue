<template>
  <div>
    <Navigation />
    <!-- Hero — pain-point: a website should sell, not just look nice (Minden) -->
      ...
      <div class="hero-shell__inner container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          <div class="lg:col-span-7" data-aos="fade-right">
            <p class="hero-shell__eyebrow">Webdesign · Minden</p>
            <h1 class="hero-shell__headline">
              Website erstellen lassen in Minden.<br />
            ...
            <p class="hero-shell__sub">
              ...
              für Unternehmen in Minden und dem Weserbergland, die aus Besuchern messbar
            ...
            <div class="hero-shell__trust">
              ...
              <div>
                <div class="hero-shell__stat-num">Minden</div>
      ...
      <div class="container mx-auto px-4">
        <div class="text-center mb-12">
          <h3 class="text-lg text-primary font-semibold" data-aos="fade-up">
            Webdesign-Agentur direkt in Minden
          </h3>
          <h2
...
// SEO Meta Tags für Webdesign & Website-Erstellung in Minden
useHead({
  htmlAttrs: { lang: "de" },
  title: "Website erstellen lassen in Minden | Professionelles Webdesign | Orangize",
  meta: [
    { name: "description", content: "Website erstellen lassen in Minden ✓ Lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung vor Ort in Minden & Ostwestfalen." },
    { name: "keywords", content: "Website erstellen lassen minden, webdesign minden, homepage erstellen minden, landingpage minden, webdesign agentur minden, professionelle Website minden, responsive webdesign minden, seo Website minden" },
    { name: "author", content: "Orangize Digital" },
    { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1" },
    { name: "geo.region", content: "DE-NW" },
    { name: "geo.placename", content: "Minden" },
    { property: "og:title", content: "Website erstellen lassen in Minden | Professionelles Webdesign | Orangize" },
    ...
    { property: "og:image:alt", content: "Website erstellen lassen in Minden | Professionelles Webdesign | Orangize" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Website erstellen lassen in Minden | Professionelles Webdesign | Orangize" },
        ...
        "@graph": [
          {
            ...
            name: "Website erstellen lassen in Minden",
            description: "Website erstellen lassen in Minden ✓ Lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung vor Ort in Minden & Ostwestfalen.",
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Website erstellen lassen in Minden", item: `https://orangize.de${route.path}` },
            ],
          },
        ],
      }),
