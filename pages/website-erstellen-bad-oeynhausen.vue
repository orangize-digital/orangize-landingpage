<template>
  <div>
    <Navigation />
    <!-- Hero — pain-point: a website should sell, not just look nice (Bad Oeynhausen) -->
      ...
      <div class="hero-shell__inner container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          <div class="lg:col-span-7" data-aos="fade-right">
            <p class="hero-shell__eyebrow">Webdesign · Bad Oeynhausen</p>
            <h1 class="hero-shell__headline">
              Website erstellen lassen in Bad Oeynhausen.<br />
            ...
            <p class="hero-shell__sub">
              ...
              für Unternehmen in Bad Oeynhausen und Ostwestfalen, die aus Besuchern messbar
            ...
            <div class="hero-shell__trust">
              ...
              <div>
                <div class="hero-shell__stat-num">Bad Oeynhausen</div>
      ...
      <div class="container mx-auto px-4">
        <div class="text-center mb-12">
          <h3 class="text-lg text-primary font-semibold" data-aos="fade-up">
            Ihre Webdesign-Agentur aus Bad Oeynhausen
          </h3>
          <h2
            ...
            data-aos-delay="100"
          >
            Warum Mindener Unternehmen auf uns vertrauen
          </h2>
        </div>
...
// SEO Meta Tags für Webdesign & Website-Erstellung in Bad Oeynhausen
useHead({
  htmlAttrs: { lang: "de" },
  title: "Website erstellen lassen in Bad Oeynhausen | Lokale Webdesign Agentur | Orangize",
  meta: [
    { name: "description", content: "Website erstellen lassen in Bad Oeynhausen ✓ Ihre lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung direkt aus Bad Oeynhausen." },
    { name: "keywords", content: "Website erstellen lassen bad oeynhausen, webdesign bad oeynhausen, homepage erstellen bad oeynhausen, landingpage bad oeynhausen, webdesign agentur bad oeynhausen, professionelle Website bad oeynhausen, responsive webdesign bad oeynhausen" },
    { name: "author", content: "Orangize Digital" },
    { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1" },
    { name: "geo.region", content: "DE-NW" },
    { name: "geo.placename", content: "Bad Oeynhausen" },
    { property: "og:title", content: "Website erstellen lassen in Bad Oeynhausen | Lokale Webdesign Agentur | Orangize" },
    { property: "og:description", content: "Ihre Webdesign-Agentur direkt aus Bad Oeynhausen. Professionelle Websites und persönliche Betreuung für Unternehmen in Bad Oeynhausen und Ostwestfalen." },
    ...
    { property: "og:image:alt", content: "Website erstellen lassen in Bad Oeynhausen | Lokale Webdesign Agentur | Orangize" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Website erstellen lassen in Bad Oeynhausen | Lokale Webdesign Agentur | Orangize" },
    { name: "twitter:description", content: "Ihre Webdesign-Agentur direkt aus Bad Oeynhausen. Professionelle Websites und persönliche Betreuung für Unternehmen in Bad Oeynhausen und Ostwestfalen." },
        ...
        "@graph": [
          {
            ...
            name: "Website erstellen lassen in Bad Oeynhausen",
            description: "Website erstellen lassen in Bad Oeynhausen ✓ Ihre lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung direkt aus Bad Oeynhausen.",
            url: `https://orangize.de${route.path}`,
            areaServed: { "@type": "City", name: "Bad Oeynhausen" },
          ...
          },
          {
            ...
            areaServed: "Bad Oeynhausen",
          },
          {
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Startseite", item: "https://orangize.de" },
              { "@type": "ListItem", position: 2, name: "Website erstellen lassen in Bad Oeynhausen", item: `https://orangize.de${route.path}` },
            ],
          },
        ],
      }),
