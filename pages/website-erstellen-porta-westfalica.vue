<template>
  <div>
    <Navigation />
    <!-- Hero — pain-point: a website should sell, not just look nice (Porta Westfalica) -->
      ...
      <div class="hero-shell__inner container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          <div class="lg:col-span-7" data-aos="fade-right">
            <p class="hero-shell__eyebrow">Webdesign · Porta Westfalica</p>
            <h1 class="hero-shell__headline">
              Website erstellen lassen in Porta Westfalica.<br />
            ...
            <p class="hero-shell__sub">
              ...
              für Unternehmen in Porta Westfalica und dem Weserbergland, die aus Besuchern messbar
            ...
            <div class="hero-shell__trust">
              ...
              <div>
                <div class="hero-shell__stat-num">Porta Westfalica</div>
      ...
      <div class="container mx-auto px-4">
        <div class="text-center mb-12">
          <h3 class="text-lg text-primary font-semibold" data-aos="fade-up">
            Webdesign-Agentur direkt in Porta Westfalica
          </h3>
          <h2
...
// SEO Meta Tags für Webdesign & Website-Erstellung in Porta Westfalica
useHead({
  htmlAttrs: { lang: "de" },
  title: "Website erstellen lassen in Porta Westfalica | Professionelles Webdesign | Orangize",
  meta: [
    { name: "description", content: "Website erstellen lassen in Porta Westfalica ✓ Lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung vor Ort in Porta Westfalica & Ostwestfalen." },
    { name: "keywords", content: "Website erstellen lassen porta westfalica, webdesign porta westfalica, homepage erstellen porta westfalica, landingpage porta westfalica, webdesign agentur porta westfalica, professionelle Website porta westfalica, responsive webdesign porta westfalica" },
    ...
    { property: "og:title", content: "Website erstellen lassen in Porta Westfalica | Professionelles Webdesign | Orangize" },
    ...
    { property: "og:image:alt", content: "Website erstellen lassen in Porta Westfalica | Professionelles Webdesign | Orangize" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Website erstellen lassen in Porta Westfalica | Professionelles Webdesign | Orangize" },
        ...
        "@graph": [
          {
            ...
            name: "Website erstellen lassen in Porta Westfalica",
            description: "Website erstellen lassen in Porta Westfalica ✓ Lokale Webdesign Agentur ✓ Responsive Design ✓ SEO-optimiert ✓ Persönliche Betreuung vor Ort in Porta Westfalica & Ostwestfalen.",
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Website erstellen lassen in Porta Westfalica", item: `https://orangize.de${route.path}` },
            ],
          },
        ],
      }),
