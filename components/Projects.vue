...
import ahUmzuegeImage from "~/assets/images/ah-umzuege.png";
...
const projects = [
  {
    ...
    description:
      "Modernes Webdesign und Entwicklung für ein Entrümpelungs- und Umzugsunternehmen – inklusive SEO-Optimierung für lokale Sichtbarkeit und mehr Kundenanfragen.",
    image: ahUmzuegeImage,
    link: "#",
  },
  {
