...
useHead({
  title:
    "Google Ads einrichten & optimieren in Bad Oeynhausen | Professionelle Betreuung | Orangize",
  meta: [
    {
      name: "description",
      content:
        "Google Ads einrichten & optimieren lassen in Bad Oeynhausen ✓ Mehr Conversions ✓ Weniger Streuverlust ✓ Persönliche Beratung ✓ Für Herford, Minden & Porta Westfalica.",
    },
    {
      name: "keywords",
      content:
        "google ads bad oeynhausen, google ads einrichten, google ads optimieren, google ads agentur herford, sea agentur minden, google ads porta westfalica, google adwords beratung, google ads kampagne erstellen",
    },
    {
      property: "og:title",
      content:
    ...
    },
    {
      ...
      content:
        "Google Ads in Bad Oeynhausen professionell einrichten & optimieren lassen. Persönliche Betreuung für Herford, Porta Westfalica & Minden – mehr Ergebnisse, weniger Kosten.",
    },
    {
      property: "og:type",
      content: "website",
