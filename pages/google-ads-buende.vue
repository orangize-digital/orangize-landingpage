<template>
  <div>
    <Navigation />
    <!-- Hero — pain-point: wasted ad budget → real inquiries (Bünde) -->
      ...
      <div class="hero-shell__inner container mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          <div class="lg:col-span-7" data-aos="fade-right">
            <p class="hero-shell__eyebrow">Google Ads · Bünde</p>
            <h1 class="hero-shell__headline">
              Google Ads Agentur in Bünde.<br />
            ...
            <p class="hero-shell__sub">
              ...
              Kampagnen für Unternehmen in Bünde und Ostwestfalen, die nachweisbar
...
// SEO Meta Tags für Google Ads Betreuung in Bünde und Umgebung
useHead({
  htmlAttrs: { lang: "de" },
  title: "Google Ads Agentur Bünde | Professionelle Kampagnen-Betreuung | Orangize",
  meta: [
    { name: "description", content: "Google Ads Agentur Bünde ✓ Professionelle Kampagnen für Ostwestfalen ✓ ROI-Optimierung ✓ Lokale Expertise ✓ Kostenlose Beratung ✓ Messbare Ergebnisse." },
    { name: "keywords", content: "google ads bünde, google ads agentur bünde, sea agentur ostwestfalen, google ads beratung bünde, google adwords bünde, google ads optimierung, ppc agentur bünde, google kampagnen ostwestfalen" },
    { name: "author", content: "Orangize Digital" },
    { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1" },
    { name: "geo.region", content: "DE-NW" },
    { name: "geo.placename", content: "Bünde" },
    { property: "og:title", content: "Google Ads Agentur Bünde | Professionelle Kampagnen-Betreuung | Orangize" },
    { property: "og:description", content: "Professionelle Google Ads Agentur in Bünde. Spezialisiert auf ROI-Optimierung und messbare Ergebnisse für Unternehmen in Ostwestfalen. Kostenlose Erstberatung!" },
    ...
    { property: "og:image:alt", content: "Google Ads Agentur Bünde | Professionelle Kampagnen-Betreuung | Orangize" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Google Ads Agentur Bünde | Professionelle Kampagnen-Betreuung | Orangize" },
    { name: "twitter:description", content: "Professionelle Google Ads Agentur in Bünde. Spezialisiert auf ROI-Optimierung und messbare Ergebnisse für Unternehmen in Ostwestfalen. Kostenlose Erstberatung!" },
        ...
        "@graph": [
          {
            ...
            name: "Google Ads Agentur Bünde",
            description: "Google Ads Agentur Bünde ✓ Professionelle Kampagnen für Ostwestfalen ✓ ROI-Optimierung ✓ Lokale Expertise ✓ Kostenlose Beratung ✓ Messbare Ergebnisse.",
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Google Ads Agentur Bünde", item: `https://orangize.de${route.path}` },
            ],
          },
        ],
      }),
